...
HV_CALIB_FILE = '~/FNL_Neutron_Generator_Control/02.Sensors/01.HV_Dose_twofast-rpi3-0/Python/HV_readout_calibration.txt'
I_CALIB_FILE = '~/FNL_Neutron_Generator_Control/02.Sensors/01.HV_Dose_twofast-rpi3-0/Python/I_readout_calibration.txt'
